"""Synthetic observation-ratio metrics summary for the v7e stage1 branch."""
...
class V7EStage1SyntheticMetricsConfig:
    project_root: Path = Path.cwd()
    output_root: Path = Path("results/real_skeleton_v7e_stage1_paper_transition_rescue_synthetic_metrics")
    stage1_results_root: Path = Path(
        "results/real_skeleton_two_stage_rock_transition_v7e_stage1_paper_transition_rescue_tcn_ensemble"
    )
    stage2_reuse_results_root: Path = Path(
...
def write_v7e_stage1_synthetic_metrics(config: V7EStage1SyntheticMetricsConfig) -> dict[str, Any]:
    ...
    stage2 = _stage_status(
        project_root=project_root,
        results_root=config.stage2_reuse_results_root,
...
__all__ = ["V7EStage1SyntheticMetricsConfig", "write_v7e_stage1_synthetic_metrics"]
